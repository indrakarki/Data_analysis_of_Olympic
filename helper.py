...
def fetch_medal_tally(df, year, country):
    '''fetch_medal_tally function will take the data frame and finds overall analysis of each country in single olypmic,
        anlysis of each olympic,analysis of each olympic
...
def medal_tally(df):
    # we will remove duplicates on the basis of Team	NOC	Games	Year	Season	City	Sport	Event	Medal	region
...
def country_year_list(df):
    # let us get all the years when olympic was held
...
def weight_v_height(df, sport):s
